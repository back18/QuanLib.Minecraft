...
{
    public class StartingEventPublisher : ILogEventPublisher
    {
        public StartingEventPublisher(EventHandler eventHandler, object? sender = null)
        {
        ...
        {
            if (message.StartsWith("Preparing start region"))
            {
