...
{
    public class StoppingEventPublisher : ILogEventPublisher
    {
        private const string MESSAGE = "Stopping server";

        public StoppingEventPublisher(EventHandler eventHandler, object? sender = null)
        {
