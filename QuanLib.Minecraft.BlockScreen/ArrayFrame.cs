...
{
    public class ArrayFrame : AbstractFrame
    {
        ...
        public override int Width => _ids.GetLength(0);

        public override int Height => _ids.GetLength(1);
        ...
        public override void CorrectSize(Size size, ContentAnchor anchor, string id)
        {
